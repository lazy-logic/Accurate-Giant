 ...
 * operator including ACCURATE GIANT COMPANY LIMITED. It does NOT publish
 * the per-operator licence numbers — those live on each operator's licence
 * certificate. Use NLA_LICENCE_NUMBER for the formal number when the owner
 * supplies it; until then it's null and components fall back to the
 * "NLA-registered" wording (verifiable via the linked register).
 */
