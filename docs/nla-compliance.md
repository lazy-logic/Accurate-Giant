# NLA & Regulatory Compliance — Accurate Giant Company Ltd. website
...
| **NLA license terms** | Specific to Accurate Giant Company Ltd. — license number, scope (Accra), renewal date. | Footer (license number) + License page |
...
- [ ] **Charity-status disclosure** — short line identifying Accurate Giant as a licensed charity.
- [ ] **Operator legal name** — "Accurate Giant Company Ltd." in copyright line.
...
- [ ] **Self-exclusion mechanism** — confirm with owner whether Accurate Giant operates its own, or refers users to an NLA / external programme.
