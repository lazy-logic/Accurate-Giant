 ...
 *
 * The hardcoded #01277a / #011d5d hover/active values are darker shades of
 * --brand-primary used only on the primary button — not new tokens, just tints.
 */
...
const variantClasses = {
  primary:
    "bg-brand-primary text-white hover:bg-[#01277a] active:bg-[#011d5d] shadow-soft",
  secondary:
