...
export function ScrollToTop() {
  ...
  return (
    <button
      ...
      className={cn(
        "fixed bottom-6 right-6 md:bottom-8 md:right-8 z-50 inline-flex items-center justify-center w-12 h-12 rounded-full bg-brand-primary text-white shadow-lifted transition-all duration-300 hover:bg-[#01277a] hover:-translate-y-0.5",
        visible
