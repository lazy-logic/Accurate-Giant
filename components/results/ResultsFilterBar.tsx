      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:gap-4">
        <label className="flex items-center gap-2 text-xs">
          ...
          <select
            ...
            className="h-9 px-2 min-w-[160px] rounded-md border border-brand-border bg-brand-paper text-sm font-medium text-brand-ink"
          >
        ...
        <label className="flex items-center gap-2 text-xs">
          ...
          <input
            ...
            className="h-9 px-2 rounded-md border border-brand-border bg-brand-paper text-sm text-brand-ink tnum"
          />
        </label>
        ...
        {hasActive && (
          <button
            ...
            className="inline-flex items-center gap-1 h-9 px-3 text-xs font-medium text-brand-ink-muted hover:text-brand-primary"
          >
