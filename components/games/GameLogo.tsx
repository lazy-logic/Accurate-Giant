  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: [
          // Inner curve at the bottom — the sphere's terminator
          "inset -8px -14px 28px rgba(20,30,60,0.18)",
          // Inner highlight along the top
          "inset 4px 6px 14px rgba(255,255,255,0.95)",
          // Outer drop shadows (close + ambient + cyan halo)
          "0 8px 18px rgba(20,30,60,0.18)",
          "0 22px 44px rgba(20,30,60,0.20)",
          "0 32px 60px rgba(1,50,153,0.14)",
        ].join(", "),
      }}
    >
