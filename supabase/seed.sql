...
insert into games (slug, name, hook, long_description, schedule, schedule_label, channel, channel_detail, prize_structure, featured, introduced_year, sort_order, logo_url) values
  ('national-week-lotto', 'National Week Lotto',
    ...
    array['saturday'], 'Saturdays', 'standard', null, '5/90 fixed odds', true, 1962, 10, '/games/national-weekly.png'),
  ...
  ('mid-week', 'Mid Week',
    ...
    array['wednesday'], 'Wednesdays', 'standard', null, '5/90 fixed odds', true, 2003, 20, '/games/mid-week.png'),
  ...
  ('monday-special', 'Monday Special',
    ...
    array['monday'], 'Mondays', 'standard', null, '5/90 fixed odds', false, null, 30, '/games/monday-special.png'),
  ...
  ('lucky-tuesday', 'Lucky Tuesday',
    ...
    array['tuesday'], 'Tuesdays', 'standard', null, null, false, 2007, 40, '/games/lucky-tuesday.png'),
  ...
  ('fortune-thursday', 'Fortune Thursday',
    ...
    array['thursday'], 'Thursdays', 'standard', null, '5/90 fixed odds', false, null, 50, '/games/fortune-thursday.png'),
  ...
  ('friday-bonanza', 'Friday Bonanza',
    ...
    array['friday'], 'Fridays', 'standard', null, null, false, 2007, 60, '/games/friday-bonanza.png'),
  ...
  ('sunday-aseda', 'Sunday Aseda',
    ...
    array['sunday'], 'Sundays', 'standard', null, '5/90 fixed odds', true, 2022, 70, '/games/sunday-aseda.png'),
  ...
  ('noon-rush', 'Noon Rush',
    ...
    array[]::text[], 'Schedule TBC', 'standard', null, null, false, null, 150, '/games/noon-rush.png')
