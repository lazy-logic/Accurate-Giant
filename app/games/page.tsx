...
export const metadata: Metadata = {
  title: "Games",
  description:
    "Every NLA-licensed game we operate at Accurate Giant. Filter by day or channel; tap a game to see its rules, schedule, and recent results.",
};
  ...
  return (
    <>
      <PageHeader
        ...
        subtitle={`${allGames.length} draws across the week. Tap a game for rules, draw schedule, and recent winning numbers. Or open the AG mobile app to play any of them.`}
      />
