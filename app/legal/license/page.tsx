...
export const metadata: Metadata = {
  ...
  description:
    "Accurate Giant Company Ltd. is a registered private lotto operator under the National Lottery Authority of Ghana (Act 722). Verify our registration on the public NLA register.",
};
            ...
            <div className="lg:col-span-8 space-y-10">
              ...
              <div>
                <h3 className="font-display font-extrabold text-xl md:text-2xl text-brand-ink mb-5 tracking-[-0.015em]">
                  <span className="text-brand-secondary tnum mr-2">01</span>
                  Licence details
                </h3>
              ...
              <div>
                <h3 className="font-display font-extrabold text-xl md:text-2xl text-brand-ink mb-3 tracking-[-0.015em]">
                  <span className="text-brand-secondary tnum mr-2">02</span>
              ...
              <div>
                <h3 className="font-display font-extrabold text-xl md:text-2xl text-brand-ink mb-3 tracking-[-0.015em]">
                  <span className="text-brand-secondary tnum mr-2">03</span>
                  Group structure
                </h3>
                <p className="text-base text-brand-ink leading-relaxed">
                  Accurate Giant Company Ltd. operates alongside two related
                  entities: AG Lottery Ltd. (lotto-specific operations and
                  agent network) and AG Co-operative Credit Union Ltd.
                  (cooperative finance, registered separately under Ghana's
