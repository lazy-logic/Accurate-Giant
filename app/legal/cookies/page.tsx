...
export const metadata: Metadata = {
  title: "Cookie policy",
  description:
    "What cookies and local-storage entries we use on the Accurate Giant website, what they do, and how to manage them.",
};
        ...
        <div className="not-prose overflow-x-auto rounded-lg border border-brand-border my-4">
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-brand-border">
              ...
              <tr>
                <td className="px-4 py-3 font-mono text-xs">ag_consent</td>
              ...
              <tr>
                <td className="px-4 py-3 font-mono text-xs">ag_analytics_id</td>
