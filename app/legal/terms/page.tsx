...
export const metadata: Metadata = {
  ...
  description:
    "Terms of service for the Accurate Giant Company Ltd. website and the NLA-licensed games we operate.",
};
...
const SECTIONS: LegalSection[] = [
  {
    id: "acceptance",
    title: "Acceptance",
    body: "By accessing this website or playing any game operated by Accurate Giant Company Ltd. (the operator), you agree to these Terms of Service together with our Privacy Policy and any game-specific rules. If you do not accept these terms, please do not use the site or our services.",
  },
  {
    id: "eligibility",
    title: "Eligibility",
    body: (
      <>
        <p>
          ...
          game operated by Accurate Giant. By playing, you confirm that you
    ...
    body: (
      <ul>
        ...
        <li>
          ...
          <a href="mailto:compliance@accurategiant.com">compliance@accurategiant.com</a>.
        </li>
  ...
  },
  {
    ...
    body: "All site content, design, and the AG brand belong to Accurate Giant Company Ltd. or its licensors. NLA-licensed game names and artwork remain the property of the National Lottery Authority and are used under the operating framework of Act 722.",
  },
  {
    id: "liability",
    title: "Limitation of liability",
    body: "To the fullest extent permitted by Ghanaian law, Accurate Giant Company Ltd. is not liable for any indirect, incidental, or consequential loss arising from the use of this website. Nothing in these Terms limits any liability that cannot lawfully be excluded.",
  },
  {
    id: "termination",
    ...
    body: (
      <>
        <p>
          ...
          <a href="mailto:legal@accurategiant.com">legal@accurategiant.com</a>{" "}
  ...
  return (
    <>
      <PageHeader
        eyebrow="Legal"
        title="Terms of service."
        subtitle="The terms that apply to your use of this website and to gameplay through Accurate Giant's NLA-licensed services."
        breadcrumbs={[
          { label: "Home", href: "/" },
          { label: "Legal" },
          { label: "Terms" },
