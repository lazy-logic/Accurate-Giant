...
export const metadata: Metadata = {
  ...
  description:
    "How Accurate Giant Company Ltd. collects, uses, and protects your personal data. Aligned with Ghana's Data Protection Act 2012 (Act 843).",
};
...
const SECTIONS: LegalSection[] = [
  {
    id: "intro",
    title: "Who we are",
    body: "Accurate Giant Company Ltd. (the operator) is the Data Controller for personal data collected through this website. We operate under the National Lotto Act 2006 (Act 722) and handle personal data in accordance with Ghana's Data Protection Act 2012 (Act 843).",
  },
  {
    id: "data",
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p>
          Direct requests to{" "}
          <a href="mailto:privacy@accurategiant.com">privacy@accurategiant.com</a>.
        </p>
      </>
    ),
  },
