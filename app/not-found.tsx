...
export default function NotFound() {
  return (
    <section className="relative overflow-hidden -mt-28 md:-mt-32 pt-28 md:pt-32 pb-24 md:pb-32 min-h-[80vh] flex items-center">
      {/* Mesh background — quieter than the Hero's */}
      <div
        aria-hidden
        className="absolute inset-0 z-0"
        style={{
          background:
            "radial-gradient(ellipse 60% 60% at 88% -5%, rgba(0,185,239,0.30), transparent 60%), radial-gradient(ellipse 55% 65% at 12% 105%, rgba(1,50,153,0.22), transparent 55%), radial-gradient(circle at 30% 20%, rgba(255,255,255,0.85) 0%, transparent 65%)",
        }}
      />
      {/* Dot grid */}
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle, rgba(1,50,153,0.22) 1.2px, transparent 1.2px)",
