      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-lg border border-brand-border bg-brand-paper p-8 shadow-soft">
          ...
          <p className="text-sm text-brand-ink-muted mb-6">
            Restricted to the Accurate Giant admin role.
          </p>
          ...
          {!configured && (
            ...
            >
              Supabase env vars are not set. See <code className="font-mono">docs/supabase-setup.md</code>.
            </div>
          )}
          ...
          <form action="/api/admin/login" method="post" className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full h-11 rounded-md bg-brand-primary text-white font-medium hover:bg-[#01277a] transition-colors"
            >
              Sign in
            </button>
          </form>
