    ...
    <>
      <div className="flex items-center justify-between gap-4 mb-6">
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 h-11 px-5 rounded-md bg-brand-primary text-white font-semibold text-sm hover:bg-[#01277a] transition-colors shadow-soft"
        >
      ...
      {!configured && (
        <div className="rounded-lg border border-brand-warning/40 bg-brand-warning/5 p-5 text-sm text-brand-ink">
          ...
          <p className="text-brand-ink-muted">
            ...
            <code className="font-mono">.env.local</code>, then run the migrations
            in <code className="font-mono">supabase/migrations/</code>. See{" "}
            <code className="font-mono">docs/supabase-setup.md</code>.
          </p>
        </div>
      )}
