    ...
    <form action={formAction} className="space-y-6 max-w-2xl">
      ...
      <div className="flex items-center gap-3 pt-4 border-t border-brand-border">
        <button
          type="submit"
          disabled={pending}
          className="inline-flex items-center justify-center h-11 px-6 rounded-md bg-brand-primary text-white font-semibold text-sm hover:bg-[#01277a] disabled:opacity-60 disabled:cursor-not-allowed transition-colors"
        >
